...
import { CommonBannerProps } from '@libs'
import { ComponentSettings } from "../../../../editor/Settings";
import { mediaStyles } from "layout/src/editor/Settings/type";

export const craftProps: UserComponent<CommonBannerProps & mediaStyles>["craft"] = {
